...
type SeedService={key:string;name:string;category:string;mode:string;base:number;rangeMax?:number;confirmation?:boolean;prices?:Partial<Record<PricingClass|WeightTierCode,number[]|number>>};
...
export const defaultServices:readonly SeedService[]=[
 ...
 ...[["nail-trim-buff","Nail Trim + Buff",2000],["ear-cleaning-plucking","Ear Cleaning + Plucking",1000],["teeth-brushing","Teeth Brushing",1000],["gland-expression","Gland Expression",1000],["paw-balm","Paw Balm",1000],["pawdicure","Pawdicure",4000],["face-trim","Face Trim",1500],["eye-visor-trim","Eye + Visor Trim",1000],["feet-trim","Feet Trim",1000],["sanitary-trim","Sanitary Trim",1000],["rear-feather-trim","Rear Feather Trim",1500],["tail-trim","Tail Trim",1000],["poodle-face","Poodle Face",1500],["poodle-feet","Poodle Feet",2000]].map(([key,name,base])=>({key:String(key),name:String(name),category:"A_LA_CARTE",mode:"FIXED",base:Number(base)})),
